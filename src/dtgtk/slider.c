...
static void _slider_class_init (GtkDarktableSliderClass *klass)
{
  ...
  _slider_parent_class = g_type_class_ref(gtk_event_box_get_type ());
...
GType dtgtk_slider_get_type()
{
  ...
  if (!dtgtk_slider_type)
  {
    ...
    dtgtk_slider_type = g_type_register_static(GTK_TYPE_EVENT_BOX, "GtkDarktableSlider", &dtgtk_slider_info, (GTypeFlags) 0);
  }
